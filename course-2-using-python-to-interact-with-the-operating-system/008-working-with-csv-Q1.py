...
the information in a nicely formatted block. Fill in the gaps of the 
contents_of_file function to turn the data in the CSV file into a dictionary 
using DictReader.
'''
...
def contents_of_file(filename):
  ...
  # Open the file
  with open("flowers.csv", "r") as data_file:
